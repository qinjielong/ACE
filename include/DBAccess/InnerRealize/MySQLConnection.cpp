...
// 输出：SELECT  * FROM (SELECT ROWNUM R,TB_DLP_SELECT.* FROM((SELECT ID,DEV_ID,DEV_NAME FROM TB_DEVINFO EMP  )) TB_DLP_SELECT ) WHERE  ROWNUM  < 51 AND R >= 1
